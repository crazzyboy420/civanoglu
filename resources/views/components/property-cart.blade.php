@foreach($latest_property as $property)
    <div class="md:mr-2 bg-white rounded-md mb-6 relative pb-14">
        ...
        <div class="p-3">
            ...
            <span class="uppercase text-2xl text-gray-700 mb-1">{{$property->dynmic_price($property->price)}}</span>
            <div class="w-full">
                ...
                <span class="inline-block border-2 mb-1 border-gray-100 mr-3 py-1 px-2 rounded-2xl">{{$property->net_sqm}} sqm</span>
            </div>
        </div>
