...
<form action="{{route('propertise')}}" method="GET" class="flex items-center w-full">
    <div class="w-8/12 flex justify-between items-center mr-2">
        ...
        <span class="w-0.5 bg-gray-400 h-5"></span>
        <div class="flex-col">
            <label for="sale">Buy or Rent</label>
            <select id="sale" name="sale" class="border-none outline-none focus-box-shadow-none" style="">
        ...
        <div class="flex flex-col">
            ...
            <select id="type" name="type" class="border-none outline-none focus-box-shadow-none" style="">
        ...
        <div class="flex-col flex">
            ...
            <select id="price" name="price" class="border-none outline-none focus-box-shadow-none" style="">
        ...
        <span class="w-0.5 bg-gray-400 h-6"></span>
        <div class="flex flex-col">
            <label for="bedrooms">Bedrooms</label>
            <select id="bedrooms" name="bedrooms" class="border-none outline-none focus-box-shadow-none" style="">
