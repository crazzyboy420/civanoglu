        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{route('admin-page.update',$page->id)}}" method="post" class="w-full flex justify-center">@csrf @method('put')
                        <div class="w-6/12">
                            <div class="mb-3">
                            ...
                            <div class="mb-2">
                                ...
                                <input class="civanoglu-input" type="text" id="content" name="contents" value="{{$page->content}}" required>
                                @error('contents')
                                <p class="text-red-700 text-sm pb-2">{{$message}}</p>
                                @enderror
                            </div>
