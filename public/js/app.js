...
_jquery_3_6_0_slim_min__WEBPACK_IMPORTED_MODULE_1___default()(window).scroll(function () {
  ...
  if (scroll >= 50) {
    _jquery_3_6_0_slim_min__WEBPACK_IMPORTED_MODULE_1___default()('.sticy-header').addClass('active-sticy-header');
  } else {
    _jquery_3_6_0_slim_min__WEBPACK_IMPORTED_MODULE_1___default()('.sticy-header').removeClass('active-sticy-header');
  }
});
